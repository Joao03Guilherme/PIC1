...
def main():
    ...
    # 2. Fit PCA
    print(
        f"Fitting PCA to reduce to 50 components on training data of shape {X_train.shape}..."
    )
    ...
    encodings_to_test = [
        ...
        },
        {
            ...
            "func": lambda vec: encode_diag_prob(
                vec
    ...
    for encoding_info in encodings_to_test:
        ...
        try:
            ...
            output_filename = os.path.join(
                OUTPUT_DIR, f"{encoding_info['filename_base']}.png"
            )

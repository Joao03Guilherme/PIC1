...
def save_digit_images(output_dir):
    ...
    for digit in range(10):
        ...
        plt.savefig(
            output_path, bbox_inches="tight", pad_inches=0
        )  # Added bbox_inches and pad_inches
...
if __name__ == "__main__":
    ...
    )  # Goes up two levels from src/data to PIC1
    output_directory = os.path.join(
        project_root, "latex", "Quantum inspired classification", "figures", "digits"
    )
